...
to random-walk
  ...
  ifelse ([POIs] of target > 0) [set energy energy + 0.5] [set energy energy - 0.5]

  if energy < 0 [
    reproduce
    die
  ]
;  let n-current-persons count persons
;
;
;  show [POIs] of target
;  show   energy
;  show n-current-persons
;
;  let n-died-persons (num-person - n-current-persons)
;  show n-died-persons
;  reproduce-persons
end
